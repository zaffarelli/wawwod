...
urlpatterns = [
    ...
    re_path(r'^ajax/switch/season/(?P<slug>\w+)/$', change_chronicle, name='change_chronicle'),
    re_path(r'^ajax/switch/adventure/(?P<slug>\w+)/$', change_adventure, name='change_adventure'),
