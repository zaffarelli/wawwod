...
def build_per_primogen(param=None):
    ...
    for kindred in kindreds:
        ...
        if kindred.sire == "":
            k["sire"] = (
                f"temporary-{improvise_id()}-{gen - 1}-{k['name']}-{k['family']}"
            )
        else:
            k["sire"] = kindred.sire
...
def build_gaia_wheel():
    ...
    stats = {
        "status": [
            ...
            {"label": "Status 1", "value": 0},
            {"label": "Status 2", "value": 0},
            {"label": "Status 3", "value": 0},
            {"label": "Status 4", "value": 0},
            {"label": "Status 5", "value": 0},
            {"label": "Status 6", "value": 0},
            {"label": "Status 7", "value": 0},
            {"label": "Status 8", "value": 0},
            {"label": "Status 9", "value": 0},
            {"label": "Status 10", "value": 0},
        ],
        "generation": [
            {"label": "13", "value": 0},
            {"label": "12", "value": 0},
        ...
        "sect": [
            ...
            {"label": "independents", "value": 0},
            {"label": "sabbat", "value": 0},
        ],
        "balanced": [
            {"label": "OK", "value": 0},
            {"label": "OK+", "value": 0},
...
MUNICH_DISTRICTS = {
    ...
    "MU002": {
        "name": "Ludwigvorstadt and Isarvorstadt",
        "description": "",
        "clan": toreador,
        "sectors": 8,
    },
    ...
    "MU011": {
        "name": "Milbertshofen und Am Hart",
        "description": "",
        "clan": brujah,
        "sectors": 3,
    },
    ...
    "MU018": {
        "name": "Untergiesing und Harlaching",
        "description": "",
        "clan": gangrel,
        "sectors": 5,
    },
