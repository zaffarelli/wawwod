...
def find_stat_property(creature, statistic):
    ...
    for list in lists:
        if statistic.lower() in STATS_NAMES[creature][list]:
            property = (
                f"{list[:-1]}{STATS_NAMES[creature][list].index(statistic.lower())}"
            )
...
CLANS_SPECIFICS = {
    ...
    "Caitiff": {"disciplines": [], "clan_weakness": ""},
    "Cappadocian": {
    ...
    "Panders": {"disciplines": [], "clan_weakness": ""},
    "Ravnos": {
...
ENLIGHTENMENT = {
    "Humanity": {"virtues": ["Conscience", "Self-Control", "Courage"], "clans": []},
    "Caine": {"virtues": ["Conviction", "Instinct", "Courage"], "clans": []},
    "Cathari": {"virtues": ["Conviction", "Instinct", "Courage"], "clans": []},
    "Death and the Soul": {
        "virtues": ["Conviction", "Self-Control", "Courage"],
        "clans": [],
    },
    "Evil Revelations": {"virtues": ["Conviction", "Instinct", "Courage"], "clans": []},
    "Feral Heart": {"virtues": ["Conviction", "Instinct", "Courage"], "clans": []},
    "Honorable Accord": {
        "virtues": ["Conscience", "Self-Control", "Courage"],
        "clans": [],
    },
    "Lilith": {"virtues": ["Conviction", "Instinct", "Courage"], "clans": []},
    ...
    "Night": {"virtues": ["Conviction", "Instinct", "Courage"], "clans": ["Lasombra"]},
    "Metamorphosis": {
        "virtues": ["Conviction", "Instinct", "Courage"],
        "clans": ["Tzimisce"],
    },
